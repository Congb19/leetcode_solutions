...
var leastInterval = function(tasks, n) {
    ...
    for (var i=0; i<tasks.length; i++) {
        t[tasks[i].charCodeAt()-65]+=1;
    }
    var round=0, num=tasks.length;
    //思路1 错了
    // while (num>0) {
    //     console.log("num=", num);
    //     for (var j=0;j<26;j++) {
