...
var findMedianSortedArrays = function (nums1, nums2) {
	...
	//     j = 0;
	// if (!n1) {
	// 	if (n2 % 2 == 1) return nums2[Math.floor(n2 / 2)];
	// 	else
	// 		return (
	// 			(nums2[Math.floor(n2 / 2)] + nums2[Math.floor(n2 / 2) - 1]) / 2
	// 		);
	// } else if (!n2) {
	// 	if (n1 % 2 == 1) return nums1[Math.floor(n1 / 2)];
	// 	else
	// 		return (
	// 			(nums1[Math.floor(n1 / 2)] + nums1[Math.floor(n1 / 2) - 1]) / 2
	// 		);
	// }
	...
	// 	else j++;
	// }
	// if ((n1 + n2) % 2 == 1) return nums1[i];
	// else return (nums1[i] + nums2[j]) / 2;
	// return res;
};
